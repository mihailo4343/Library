...
export class BookClient {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<BookModel[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<BookModel[]>;
        }));
    }

    protected processGetAllBooks(response: HttpResponseBase): Observable<BookModel[]> {
    ...
    createBook(model: BookModel | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/books";
        url_ = url_.replace(/[?&]$/, "");
    ...
    updateBook(model: BookModel | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/books";
        url_ = url_.replace(/[?&]$/, "");
    ...
    deleteBook(model: BookModel | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/books";
        url_ = url_.replace(/[?&]$/, "");
...
export class BookModel implements IBookModel {
    ...
    publicationDate?: moment.Moment | undefined;
